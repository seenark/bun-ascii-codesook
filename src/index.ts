...
const apple = await Bun.file("./frames/apple/00").text()
...
const blinkingFrames = await Promise.all([Bun.file("./frames/blinking/001").text(), Bun.file("./frames/blinking/002").text()])
